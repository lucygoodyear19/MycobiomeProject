...
REV <- "CAHCGATGAAGAACGCAG"
FWD <- "CCTCCSCTTANTDATATGC"
...
run <- "China_Kazakhstan_NorthKorea_Russia_SouthKorea_2019/"
country <- "PosC/"
...
path <- paste0(root_path, run, "DADA2_Results/", country, "Sample_Seqs/")
path2 <- paste0(root_path, run, "DADA2_Results/", country, "Sample_Seqs/filtN/")
...
pdf(file = paste0(path_out,"Quality_Profiles_fnFs.pdf"), paper = 'A4')
...
out <- filterAndTrim(cutFs, filtFs, maxN = 0, maxEE = 2, truncQ = 12,
